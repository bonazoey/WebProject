...
<div class="footer">
	...
	<button id="write" class="fbtn" onclick="location.href='board?cmd=new'"><img src="${pageContext.request.contextPath}/img/write_icon.png" alt="글쓰기" style="width: 50px; padding: 10px"></button>
	<button id="profile" class="fbtn" onclick="secureIssue();"><img src="${pageContext.request.contextPath}/img/profile_icon.png" alt="프로필" style="width: 50px; padding: 10px"></button>
</div>
<script>
/*=============================================
 * ready fun 호출
